...
// customLogger is a wrapper around DataDog/datadog-agent/pkg/util/log which allows nikos
// to use our logging functions
type customLogger struct{}

func (c customLogger) Debug(format string)                       { log.Debug(format) }
func (c customLogger) Info(format string)                        { log.Info(format) }
